...
public class dep1 extends JFrame implements ActionListener
{
	...
	dep1(Statement st, int i)
	{
		...
		l5 = new JLabel ("Material 1");
		l6 = new JLabel ("Material 2");
		l8 = new JLabel ("Material 3");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if (s.equals("Update Material"))
		{
			...
			stm.executeUpdate("update stock set qty_needed = qty_needed+"+m1+" where type = 1");
